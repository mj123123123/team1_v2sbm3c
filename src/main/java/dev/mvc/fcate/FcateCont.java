...
////	  /**
////	   * 전체 목록
////	   * http://localhost:9093/fcate/list_all.do
////	   * @return
////	   */
...
//	  /**
//	   * 조회
//	   * http://localhost:9093/fcate/read.do?fcateno=1
//	   * @return
//	   */
...
////	  /**
////	   * 수정폼
////	   * http://localhost:9093/fcate/update.do?fcateno=1
////	   * @return
////	   */
////	  @RequestMapping(value="/fcate/update.do", method = RequestMethod.GET)
////	  public ModelAndView update(HttpSession session, int fcateno) { // int fcateno = (int)request.getParameter("fcateno");
////	    ModelAndView mav = new ModelAndView();
////	    
////	    if (this.adminProc.isAdmin(session) == true) {
...
//	  
//	  /**
//	   * 우선 순위 높임, 10 등 -> 1 등, http://localhost:9093/fcate/update_seqno_forward.do?fcateno=1
//	   * @param fcateVO 수정할 내용
//	   * @return
//	   */
...
//	  
//	  /**
//	   * 우선 순위 낮춤, 1 등 -> 10 등, http://localhost:9093/fcate/update_seqno_backward.do?fcateno=1
