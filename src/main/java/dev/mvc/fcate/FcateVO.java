...
public class FestivalcateVO {
	...
	public String toString() {
		return "FeativalcateVO [festivalcateno=" + festivalcateno + ", festivalcatename=" + festivalcatename
				+ ", festivalcatecnt=" + festivalcatecnt + ", festivalcaterdate=" + festivalcaterdate + ", seqno="
