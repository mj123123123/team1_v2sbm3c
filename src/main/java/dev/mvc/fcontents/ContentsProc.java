...
public class ContentsProc implements ContentsProcInter {
  ...
  public ArrayList<ContentsVO> list_by_fcateno(int fcateno) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_fcateno(fcateno);
    return list;
  }
  ...
  public ArrayList<ContentsVO> list_by_fcateno_search(HashMap<String, Object> hashMap) {
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_fcateno_search(hashMap);
    return list;
  }
  ...
  public ArrayList<ContentsVO> list_by_fcateno_search_paging(ContentsVO contentsVO) {
    ...
    */
    ...
    ArrayList<ContentsVO> list = this.contentsDAO.list_by_fcateno_search_paging(contentsVO);
...
//      str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
      ...
      if (now_grp >= 2){ // 현재 그룹번호가 2이상이면 페이지수가 11페이지 이상임으로 이전 그룹으로 갈수 있는 링크 생성 
        str.append("<span class='span_box_1'><A href='"+list_file+"?&word="+word+"&now_page="+_now_page+"&fcateno="+fcateno+"'>이전</A></span>"); 
      } 
      ...
      for(int i=start_page; i<=end_page; i++){ 
        ...
        if (now_page == i){ // 목록에 출력하는 페이지가 현재페이지와 같다면 CSS 강조(차별을 둠)
          ...
          str.append("<span class='span_box_1'><A href='"+list_file+"?word="+word+"&now_page="+i+"&fcateno="+fcateno+"'>"+i+"</A></span>");   
        } 
      } 
      ...
      if (now_grp < total_grp){ 
        str.append("<span class='span_box_1'><A href='"+list_file+"?&word="+word+"&now_page="+_now_page+"&fcateno="+fcateno+"'>다음</A></span>"); 
      } 
      str.append("</DIV>"); 
