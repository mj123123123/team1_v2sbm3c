            ...
            <td class="td_bs">
              <c:choose>
                <c:when test="${fcateVO.visible == 'Y'}">
                  <a href="./update_visible_n.do?fcateno=${fcateno }" title="카테고리 공개 설정"><img src="/fcate/images/show.png" class="icon"></a>
                </c:when>
                <c:otherwise>
                  <a href="./update_visible_y.do?fcateno=${fcateno }" title="카테고리 비공개 설정"><img src="/fcate/images/hide.png" class="icon"></a>
                </c:otherwise>
              </c:choose>    
