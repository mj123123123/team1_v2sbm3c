		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<%-- 서브 메뉴가 없는 독립메뉴 --%> <a class="nav-link"
						href="/contents/list_all.do">전체 글 목록</a>
					</li>
					...
					<li class="nav-item">
						<%-- 서브 메뉴가 없는 독립메뉴 --%> <c:choose>
							...
							<c:otherwise>
								<a class="nav-link" href='/member/logout.do'>${sessionScope.id }
									로그아웃</a>
							</c:otherwise>
						</c:choose>
					</li>
					<li class="nav-item dropdown">
						<%-- 회원 서브 메뉴 --%> <a class="nav-link dropdown-toggle"
					...
					<c:choose>
						...
						<c:otherwise>
							<li class="nav-item dropdown">
								<%-- 관리자 서브 메뉴 --%> <a class="nav-link dropdown-toggle"
								data-toggle="dropdown" href="#">관리자</a>
								<div class="dropdown-menu">
									<a class="dropdown-item" href='/cate/list_all.do'>카테고리 전체
										목록</a> <a class="dropdown-item" href='/member/list.do'>회원 목록</a> <a
										class="dropdown-item" href='/recommend/list.do'>추천 목록</a> <a
										class="dropdown-item" href='/good/list.do'>좋아요 목록</a> <a
										class="dropdown-item" href='/score/list.do'>평점 목록</a> <a
										class="dropdown-item" href='/admin/logout.do'>관리자
